import type { CoinObjectDto } from '../common/objects';
import type { Provider } from '../common/providers';
    ...
    for (const object of objects) {
      result.has(object.coinObjectDto.typeArg)
        ? result.set(
            ...
            (result.get(object.coinObjectDto.typeArg) as bigint) +
              object.coinObjectDto.balance
          )
        : result.set(
            object.coinObjectDto.typeArg,
            object.coinObjectDto.balance
